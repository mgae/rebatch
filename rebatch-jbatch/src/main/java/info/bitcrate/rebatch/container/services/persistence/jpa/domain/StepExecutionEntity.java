...
public class StepExecutionEntity {
    public static interface Queries {
        String FIND_BY_EXECUTION = "info.bitcrate.rebatch.container.services.persistence.jpa.domain.StepExecutionEntity.findByExecution";
        String FIND_BY_INSTANCE_AND_NAME = "info.bitcrate.rebatch.container.services.persistence.jpa.domain.StepExecutionEntity.findByInstanceAndName";
        String DELETE_BY_INSTANCE_ID = "info.bitcrate.rebatch.container.services.persistence.jpa.domain.StepExecutionEntity.deleteByInstanceId";
    }
