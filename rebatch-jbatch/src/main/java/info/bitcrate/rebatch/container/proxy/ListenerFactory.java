 ...
 */
package info.bitcrate.rebatch.container.proxy;
...
import info.bitcrate.rebatch.jaxb.Listeners;
...
public class ListenerFactory {
    ...
    public ListenerFactory(final JSLJob jobModel, final InjectionReferences injectionRefs, final RuntimeJobExecution execution) {
        ...
        jobLevelListenerInfo.addAll(globalListeners("info.bitcrate.rebatch.job.listeners.before", injectionRefs, execution));
        ...
        jobLevelListenerInfo.addAll(globalListeners("info.bitcrate.rebatch.job.listeners.after", injectionRefs, execution));
    }
        ...
        if (stepListenerInfoList == null) {
            synchronized (this) {
                ...
                if (stepListenerInfoList == null) {
                    ...
                    stepListenerInfoList.addAll(globalListeners("info.bitcrate.rebatch.step.listeners.before", injectionRefs, execution));
                    ...
                    stepListenerInfoList.addAll(globalListeners("info.bitcrate.rebatch.step.listeners.after", injectionRefs, execution));
                }
            }
        }
