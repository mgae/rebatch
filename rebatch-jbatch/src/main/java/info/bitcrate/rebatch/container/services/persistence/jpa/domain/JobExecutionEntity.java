...
public class JobExecutionEntity {
    public static interface Queries {
        String MOST_RECENT = "info.bitcrate.rebatch.container.services.persistence.jpa.domain.JobExecutionEntity.mostRecent";
        String FIND_BY_INSTANCE = "info.bitcrate.rebatch.container.services.persistence.jpa.domain.JobExecutionEntity.findByInstance";
        String FIND_RUNNING = "info.bitcrate.rebatch.container.services.persistence.jpa.domain.JobExecutionEntity.findRunning";
        String DELETE_BY_INSTANCE_ID = "info.bitcrate.rebatch.container.services.persistence.jpa.domain.JobExecutionEntity.deleteByInstanceId";
