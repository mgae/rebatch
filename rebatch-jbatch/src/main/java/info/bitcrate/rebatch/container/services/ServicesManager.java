 ...
 */
package info.bitcrate.rebatch.container.services;
...
import info.bitcrate.rebatch.container.services.executor.DefaultThreadPoolService;
import info.bitcrate.rebatch.container.services.factory.CDIBatchArtifactFactory;
import info.bitcrate.rebatch.container.services.factory.DefaultBatchArtifactFactory;
import info.bitcrate.rebatch.container.services.kernel.DefaultBatchKernel;
import info.bitcrate.rebatch.container.services.loader.DefaultJobXMLLoaderService;
import info.bitcrate.rebatch.container.services.locator.SingletonLocator;
import info.bitcrate.rebatch.container.services.persistence.MemoryPersistenceManager;
import info.bitcrate.rebatch.container.services.security.DefaultSecurityService;
import info.bitcrate.rebatch.container.services.status.DefaultJobStatusManager;
import info.bitcrate.rebatch.container.services.transaction.DefaultBatchTransactionService;
import info.bitcrate.rebatch.container.util.BatchContainerConstants;
import info.bitcrate.rebatch.spi.BatchArtifactFactory;
import info.bitcrate.rebatch.spi.BatchService;
import info.bitcrate.rebatch.spi.BatchThreadPoolService;
import info.bitcrate.rebatch.spi.JobXMLLoaderService;
import info.bitcrate.rebatch.spi.PersistenceManagerService;
import info.bitcrate.rebatch.spi.SecurityService;
...
public class ServicesManager implements BatchContainerConstants {
    ...
    private static final String SERVICES_CONFIGURATION_FILE = "/rebatch.properties";
    ...
    /**
     * Retrieve a property value from the batch runtime config 
     * (rebatch.properties) returning the default value if the property is not
     * found.
     * 
     * @param key
     * 			property name
     * @param defaultValue
     * 			value used if the provided property name does not exist
     * @return
     * 			property value for key if found, else defaultValue
     */
        ...
        if (!isInited) {
            synchronized (isInitedLock) {
                if (!isInited) {
                    ...
                    logServices = Boolean.parseBoolean(batchRuntimeConfig.getProperty("rebatch.service-manager.log", "false"));
