...
import info.bitcrate.rebatch.container.proxy.CheckpointAlgorithmProxy;
import info.bitcrate.rebatch.container.proxy.ChunkListenerProxy;
import info.bitcrate.rebatch.container.proxy.InjectionReferences;
import info.bitcrate.rebatch.container.proxy.ItemProcessListenerProxy;
import info.bitcrate.rebatch.container.proxy.ItemProcessorProxy;
import info.bitcrate.rebatch.container.proxy.ItemReadListenerProxy;
import info.bitcrate.rebatch.container.proxy.ItemReaderProxy;
import info.bitcrate.rebatch.container.proxy.ItemWriteListenerProxy;
import info.bitcrate.rebatch.container.proxy.ItemWriterProxy;
import info.bitcrate.rebatch.container.proxy.ProxyFactory;
import info.bitcrate.rebatch.container.proxy.RetryProcessListenerProxy;
import info.bitcrate.rebatch.container.proxy.RetryReadListenerProxy;
import info.bitcrate.rebatch.container.proxy.RetryWriteListenerProxy;
                ...
                try {
                	readerProxy.open(
                			Serializations.deserialize(
                					readerChkptData.getRestartToken()));
        ...
        try {
            ...
            if (writerChkptData != null) {
                ...
                try {
                	writerProxy.open(
                			Serializations.deserialize(
                					writerChkptData.getRestartToken()));
