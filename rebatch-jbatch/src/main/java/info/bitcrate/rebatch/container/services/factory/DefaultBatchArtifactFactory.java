...
*/
package info.bitcrate.rebatch.container.services.factory;
...
import info.bitcrate.rebatch.container.util.DependencyInjections;
...
public class DefaultBatchArtifactFactory implements BatchArtifactFactory, XMLStreamConstants {
    ...
    private ArtifactMap createArtifactsMap(final ClassLoader tccl) {
        ...
        initArtifactMapFromClassLoader(artifactMap, tccl, REBATCH_XML);
        return artifactMap;
    }
