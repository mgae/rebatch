 ...
 */
package info.bitcrate.rebatch.container.services.persistence.jpa.provider;
...
public class DefaultEntityManagerProvider implements EntityManagerProvider {
    ...
    public void init(final Properties batchConfig) {
        emf = Persistence.createEntityManagerFactory(batchConfig.getProperty("persistence.jpa.unit-name", "rebatch"));
