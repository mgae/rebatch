...
import info.bitcrate.rebatch.container.status.SplitExecutionStatus;
import info.bitcrate.rebatch.container.util.BatchFlowInSplitWorkUnit;
import info.bitcrate.rebatch.container.util.BatchParallelWorkUnit;
...
public class SplitController implements ExecutionElementController {
    ...
    private SplitExecutionStatus waitForCompletionAndAggregateStatus() {
        ...
        for (@SuppressWarnings("unused") final JSLJob ignored : subJobs) {
