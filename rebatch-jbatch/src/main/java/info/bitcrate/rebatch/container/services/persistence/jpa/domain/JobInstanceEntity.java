 ...
 */
package info.bitcrate.rebatch.container.services.persistence.jpa.domain;
...
public class JobInstanceEntity {
    public static interface Queries {
        String COUNT_BY_NAME_AND_TAG = "info.bitcrate.rebatch.container.services.persistence.jpa.domain.JobInstanceEntity.countByNameAndTag";
        String COUNT_BY_NAME = "info.bitcrate.rebatch.container.services.persistence.jpa.domain.JobInstanceEntity.countByName";
        String FIND_BY_NAME = "info.bitcrate.rebatch.container.services.persistence.jpa.domain.JobInstanceEntity.findByName";
        String FIND_BY_NAME_AND_TAG = "info.bitcrate.rebatch.container.services.persistence.jpa.domain.JobInstanceEntity.findByNameAndTag";
        String FIND_EXTERNALS = "info.bitcrate.rebatch.container.services.persistence.jpa.domain.JobInstanceEntity.findExternals";
        String FIND_FROM_EXECUTION = "info.bitcrate.rebatch.container.services.persistence.jpa.domain.JobInstanceEntity.findByExecution";
        String DELETE_BY_INSTANCE_ID = "info.bitcrate.rebatch.container.services.persistence.jpa.domain.JobInstanceEntity.deleteFromInstanceId";
    }
