 ...
 */
package info.bitcrate.rebatch.test.tck.lifecycle;
...
public class ContainerLifecycle implements ITestListener {
    ...
    public void onStart(final ITestContext iTestContext) {
        ...
        container = EJBContainer.createEJBContainer(new PropertiesBuilder()
            ...
            .p("jdbc/rebatch", "new://Resource?type=DataSource")
            .p("jdbc/rebatch.JdbcDriver", EmbeddedDriver.class.getName())
            .p("jdbc/rebatch.JdbcUrl", "jdbc:derby:memory:rebatch" + ";create=true")
            .p("jdbc/rebatch.UserName", "app")
            .p("jdbc/rebatch.Password", "app")
            .p("jdbc/rebatch.JtaManaged", Boolean.FALSE.toString())
            .build());
